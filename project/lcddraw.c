...
void newShape(u_int color,u_int color2){
  ...
  drawString5x7(20,100,"My face",COLOR_YELLOW,COLOR_RED);
  drawString5x7(20,110,"After I see",COLOR_YELLOW,COLOR_RED);
  drawString5x7(20,120,"The final",COLOR_YELLOW,COLOR_RED);
  
}
  

void siren_colors(u_int color1, u_int color2){
